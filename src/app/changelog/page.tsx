    ...
    updatedWords.length && (
      <div className="">
        ...
        <div className="container max-w-[600px] mx-auto px-4 mt-10">
          <h2 className="font-sans font-semibold text-2xl text-center">
            Dernières modifications du lexique
          </h2>
          <div className="mt-5 mb-10 w-[60%] m-auto">
            <Progress
              value={
                (100 * updatedWordsCount.updatedAt) / updatedWordsCount._all
              }
              className="w-full"
            />
            <p className="font-medium text-gray-500 text-sm mt-1">
              {(
                (100 * updatedWordsCount.updatedAt) /
                updatedWordsCount._all
              ).toFixed(1)}
              % des mots vérifiés
            </p>
          </div>
              ...
              <ul>
                {words.map((word) => (
                  <li key={word.strong} className="flex flex-row">
                    ...
                    <div className="font-serif text-xl grow ml-3">
                      {word.gloss} <StrongTag strong={word.strong} />
                    </div>
                  </li>
                ))}
              </ul>
          ...
          <h3 className="font-serif text-lg text-center mt-10 mb-3">
            et bien plus encore dans le passé...
          </h3>
        </div>
      </div>
    )
