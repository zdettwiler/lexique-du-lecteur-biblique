                ...
                <OverlayTrigger
                  ...
                  overlay={
                    <Popover id="popover-basic">
                      ...
                      <Popover.Body>
                        Indiquer les chapitres désirés, séparés par une virgule.
                        Pour des sections, séparer d'un tiret.
                        <br />
        ...
        {!!lexicon.length && (
          <>
            ...
            <Alert variant="warning">
              <b>🚧 Contribuez au LLB!</b> Le Lexique du Lecteur Biblique n'est
              pas parfait. Certaines définitions mériteraient d'être corrigées.
              N'hésitez pas à cliquer sur un mot et à proposer des améliorations
              aux définitions. Merci d'avance!
            </Alert>
          </>
        )}
      </Container>
